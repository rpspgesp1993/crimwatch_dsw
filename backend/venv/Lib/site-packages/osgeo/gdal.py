...
def CopyFileRestartable(*args) -> "char **":
...
def CPLReadLineL(*args) -> "char const *":
...
def MultipartUploadGetCapabilities(*args) -> "int *":
...
def MultipartUploadStart(*args) -> "retStringAndCPLFree *":
...
def MultipartUploadAddPart(*args) -> "retStringAndCPLFree *":
...
def MultipartUploadEnd(*args) -> "bool":
...
def MultipartUploadAbort(*args) -> "bool":
...
def MDArray_GetMeshGrid(*args) -> "size_t *":
    r"""MDArray_GetMeshGrid(int nInputArrays, char ** options=None)"""
    return _gdal.MDArray_GetMeshGrid(*args)
...
class Attribute(object):
    ...
    def ReadAsInt64(self, *args) -> "long long":
    ...
    def ReadAsInt64Array(self, *args) -> "void":
    ...
    def WriteInt64(self, *args) -> "CPLErr":
...
class Band(MajorObject):
    ...
    def GetSampleOverview(self, *args) -> "GDALRasterBandShadow *":
...
def GetColorInterpretationByName(*args) -> "GDALColorInterp":
